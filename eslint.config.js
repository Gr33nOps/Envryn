...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      // Modal and vault lifecycle state intentionally resets when its owner
      // opens, closes, or changes selection. Keep those explicit effects;
      // the React Hooks 7 preset's blanket prohibition is not applicable.
